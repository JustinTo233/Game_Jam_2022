...
using UnityEngine;
using Pathfinding;
public class EnemySpawnerforBiggusSlowus : MonoBehaviour
{
    ...
    private void SpawnNewEnemy()
    {
        ...
        BiggusSlowusShooting targetVar2 = newEnemy.GetComponent<BiggusSlowusShooting>();
        targetVar2.playerCharacter = player;
